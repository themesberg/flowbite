...
<h3 align="center">Glassmorphism UI</h3>
...
This project is a HUGO powered template generator for section focused UI libraries.

## Getting started

1. Make sure you have both Node and NPM installed on your machine.

2. Run `npm install` in the root folder of the project

3. Make sure you have `yarn` installed. Run `npm install --global yarn` to install it globally.

4. Make sure you have `hugo` installed. Learn more about how to [install HUGO on your machine](https://gohugo.io/getting-started/installing/).

4. Run `yarn start` to start a local server.