...
{{< example class="dark:bg-gray-800" >}}
<div id="alert-border-1" class="flex bg-blue-100 dark:bg-blue-200 border-t-4 border-blue-500 p-4 mb-4" role="alert">
...
<div id="alert-border-2" class="flex bg-red-100 dark:bg-red-200 border-t-4 border-red-500 p-4 mb-4" role="alert">
...
<div id="alert-border-3" class="flex bg-green-100 dark:bg-green-200 border-t-4 border-green-500 p-4 mb-4" role="alert">
...
<div id="alert-border-4" class="flex bg-yellow-100 dark:bg-yellow-200 border-t-4 border-yellow-500 p-4 mb-4" role="alert">
