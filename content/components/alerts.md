...
{{< example id="default-alert-example" class="dark:bg-gray-800" github="components/alerts.md" show_dark=true >}}
...
{{< example id="alerts-with-icon-example" class="dark:bg-gray-800" github="components/alerts.md" show_dark=true >}}
...
{{< example id="alerts-dismissing-example" class="dark:bg-gray-800" github="components/alerts.md" show_dark=true >}}
...
{{< example id="alerts-border-accent-example" class="dark:bg-gray-800" github="components/alerts.md" show_dark=true >}}
...
{{< example id="alerts-additional-content-example" class="dark:bg-gray-800" github="components/alerts.md" show_dark=true >}}
