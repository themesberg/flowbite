...
{{< example id="avatar-bordered-example" github="components/avatar.md" class="flex justify-center" show_dark=true >}}
...
{{< example id="avatar-placeholder-example" github="components/avatar.md" class="flex justify-center" show_dark=true >}}
...
{{< example id="avatar-placeholder-initials-example" github="components/avatar.md" class="flex justify-center" show_dark=true >}}
...
<div>
  ...
  <img data-fb-tooltip-target="tooltip-jese" class="w-10 h-10 rounded" src="/docs/images/people/profile-picture-5.jpg" alt="Medium avatar">
</div>
<div>
  ...
  <img data-fb-tooltip-target="tooltip-roberta" class="w-10 h-10 rounded" src="/docs/images/people/profile-picture-4.jpg" alt="Medium avatar">
</div>
<div>
  ...
  <img data-fb-tooltip-target="tooltip-bonnie" class="w-10 h-10 rounded" src="/docs/images/people/profile-picture-3.jpg" alt="Medium avatar">
</div>
{{< /example >}}
...
{{< example id="avatar-stacked-example" github="components/avatar.md" class="flex justify-center" show_dark=true >}}
...
{{< example id="avatar-text-example" github="components/avatar.md" class="flex justify-center" show_dark=true >}}
...
{{< example id="avatar-user-dropdown-example" class="flex justify-center space-x-4" github="components/avatar.md" show_dark=true iframeHeight="320" >}}
<img id="avatarButton" type="button" data-fb-dropdown-toggle="userDropdown" data-fb-dropdown-placement="bottom-start" class="w-10 h-10 rounded-full cursor-pointer" src="/docs/images/people/profile-picture-5.jpg" alt="User dropdown">
