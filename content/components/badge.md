...
{{< example id="default-badge-example" class="dark:bg-gray-800" github="components/badge.md" show_dark=true >}}
...
{{< example id="badge-sizes-example" class="dark:bg-gray-800" github="components/badge.md" show_dark=true >}}
...
{{< example id="badge-links-example" class="dark:bg-gray-800" github="components/badge.md" show_dark=true >}}
...
{{< example id="badge-icons-example" class="dark:bg-gray-800" github="components/badge.md" show_dark=true >}}
...
{{< example id="badge-icon-only-example" class="dark:bg-gray-800" github="components/badge.md" show_dark=true >}}
