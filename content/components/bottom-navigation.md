...
description: Use the bottom navigation component to allow users to navigate through your website or create a control bar using a menu that is positioned to the bottom of the page
group: components
toc: true
