...
<button type="button" class="text-primary bg-brand hover:bg-brand-strong focus:ring-4 focus:ring-brand-medium shadow-xs font-medium leading-5 rounded-full text-sm px-4 py-2.5 me-2 mb-2 focus:outline-none">Default</button>
{{< /example >}}
