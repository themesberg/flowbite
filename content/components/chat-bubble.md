   ...
   <div class="flex flex-col gap-1">
      ...
      <div class="flex flex-col w-full max-w-[320px] leading-1.5 p-4 border-gray-200 bg-gray-100 rounded-e-xl rounded-es-xl dark:bg-gray-700">
         <div class="flex items-start bg-gray-50 dark:bg-gray-600 rounded-xl p-2">
            <div class="me-2">
               <span class="flex items-center gap-2 text-sm font-medium text-gray-900 dark:text-white pb-2">
                  <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" class="w-5 h-5 flex-shrink-0" viewBox="0 0 20 21" fill="none">
      ...
      <div class="flex items-start justify-between rounded-xl bg-gray-50 p-2 dark:bg-gray-600">
        <div>
          ...
          <span class="flex gap-2 text-xs font-normal text-gray-500 dark:text-gray-400"
            >12 Pages
            <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" class="self-center" width="3" height="4" viewBox="0 0 3 4" fill="none">
              <circle cx="1.5" cy="2" r="1.5" fill="#6B7280" />
            </svg>
            18 MB
            <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" class="self-center" width="3" height="4" viewBox="0 0 3 4" fill="none">
