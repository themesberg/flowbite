...
{{< example id="default-drawer-example" class="flex justify-center" github="components/drawer.md" show_dark=true iframeHeight="640" >}}
...
{{< example id="drawer-placement-example" class="flex justify-center" github="components/drawer.md" show_dark=true iframeHeight="640" >}}
