...
{{< example id="default-dropdown-example" github="components/dropdowns.md" show_dark=true iframeHeight="240" >}}
...
{{< example id="dropdown-divider-example" github="components/dropdowns.md" show_dark=true iframeHeight="250" >}}
...
{{< example id="dropdown-header-example" github="components/dropdowns.md" show_dark=true iframeHeight="315" >}}
...
{{< example id="dropdown-navbar-example" github="components/dropdowns.md" show_dark=true iframeHeight="240" >}}
...
{{< example id="dropdown-sizes-example" github="components/dropdowns.md" show_dark=true iframeHeight="325" >}}
...
{{< example id="dropdown-placement-example" class="flex flex-wrap" github="components/dropdowns.md" show_dark=true iframeHeight="240" >}}
...
{{< example id="dropdown-double-placement-example" class="flex flex-wrap justify-center" github="components/dropdowns.md" iframeHeight="200" show_dark=true >}}
