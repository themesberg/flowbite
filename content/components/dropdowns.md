...
{{< example id="default-dropdown-example" class="dark:bg-gray-800" github="components/dropdowns.md" show_dark=true iframeHeight="240" >}}
...
{{< example id="dropdown-divider-example" class="dark:bg-gray-800" github="components/dropdowns.md" show_dark=true iframeHeight="250" >}}
...
{{< example id="dropdown-header-example" class="dark:bg-gray-800" github="components/dropdowns.md" show_dark=true iframeHeight="315" >}}
...
{{< example id="dropdown-navbar-example" class="dark:bg-gray-800" github="components/dropdowns.md" show_dark=true iframeHeight="240" >}}
...
{{< example id="dropdown-sizes-example" class="dark:bg-gray-800" github="components/dropdowns.md" show_dark=true iframeHeight="325" >}}
...
<button id="dropdownLargeButton" data-dropdown-toggle="dropdownLarge" class="inline-flex items-center py-3 px-5 mb-3 text-base font-medium text-center text-white bg-blue-700 rounded-lg md:mb-0 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" type="button">Large dropdown <svg class="ml-2 w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path></svg></button>
...
{{< example id="dropdown-placement-example" class="flex flex-wrap dark:bg-gray-800" github="components/dropdowns.md" show_dark=true iframeHeight="240" >}}
...
{{< example id="dropdown-double-placement-example" class="flex flex-wrap justify-center dark:bg-gray-800" github="components/dropdowns.md" iframeHeight="200" show_dark=true >}}
