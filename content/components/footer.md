...
<footer class="bg-white rounded-lg shadow m-4 dark:bg-gray-800">
    ...
    <ul class="flex flex-wrap items-center mt-3 text-sm font-medium text-gray-500 dark:text-gray-400 sm:mt-0">
        <li>
            <a href="#" class="mr-4 hover:underline md:mr-6 rtl:mr-0 rtl:ml-4 rtl:md:ml-6">About</a>
        </li>
        <li>
            <a href="#" class="mr-4 hover:underline md:mr-6 rtl:mr-0 rtl:ml-4 rtl:md:ml-6">Privacy Policy</a>
        </li>
        <li>
            <a href="#" class="mr-4 hover:underline md:mr-6 rtl:mr-0 rtl:ml-4 rtl:md:ml-6">Licensing</a>
        </li>
        <li>
    ...
    <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
      ...
      <div class="sm:flex sm:items-center sm:justify-between">
          ...
          <div class="flex mt-4 sm:justify-center sm:mt-0">
              ...
              <a href="#" class="text-gray-500 hover:text-gray-900 dark:hover:text-white ml-5 rtl:ml-0 rtl:mr-5">
...
<footer class="bg-white dark:bg-gray-900">
    ...
    <div class="px-4 py-6 bg-gray-100 dark:bg-gray-700 md:flex md:items-center md:justify-between">
        ...
        <div class="flex mt-4 sm:justify-center md:mt-0">
            <a href="#" class="text-gray-400 hover:text-gray-900 dark:hover:text-white ml-5 rtl:ml-0 rtl:mr-5">
                  <svg class="w-4 h-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 8 19">
                        <path fill-rule="evenodd" d="M6.135 3H8V0H6.135a4.147 4.147 0 0 0-4.142 4.142V6H0v3h2v9.938h3V9h2.021l.592-3H5V3.591A.6.6 0 0 1 5.592 3h.543Z" clip-rule="evenodd"/>
                    </svg>
                  <span class="sr-only">Facebook page</span>
