...
{{< example id="default-form-example" class="dark:bg-gray-800" github="components/forms.md" show_dark=true >}}
<form>
  <div class="mb-6">
...
{{< example id="form-floating-label-example" class="dark:bg-gray-800" github="components/forms.md" show_dark=true >}}
<form>
...
{{< example id="form-sizes-example" class="dark:bg-gray-800" github="components/forms.md" show_dark=true >}}
<div class="mb-6">
...
{{< example id="form-disabled-example" class="dark:bg-gray-800" github="components/forms.md" show_dark=true >}}
...
{{< example id="form-shadow-example" class="dark:bg-gray-800" github="components/forms.md" show_dark=true >}}
<form>
  <div class="mb-6">
    <label for="email" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Your email</label>
...
{{< example id="form-helper-text-example" class="dark:bg-gray-800" github="components/forms.md" show_dark=true >}}
<label for="email" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Your email</label>
...
{{< example id="form-input-icon-example" class="dark:bg-gray-800" github="components/forms.md" show_dark=true >}}
...
{{< example id="form-validation-example" class="dark:bg-gray-800" github="components/forms.md" show_dark=true >}}
<div class="mb-6">
...
{{< example id="form-textarea-example" class="dark:bg-gray-800" github="components/forms.md" show_dark=true >}}
...
{{< example id="form-select-input-example" class="dark:bg-gray-800" github="components/forms.md" show_dark=true >}}
...
{{< example id="form-checkbox-example" class="dark:bg-gray-800" github="components/forms.md" show_dark=true >}}
<fieldset>
...
{{< example id="form-radio-example" class="dark:bg-gray-800" github="components/forms.md" show_dark=true >}}
<fieldset>
...
{{< example id="form-file-input-example" class="dark:bg-gray-800" github="components/forms.md" show_dark=true >}}
...
{{< example id="form-toggle-example" class="flex flex-col flex-wrap dark:bg-gray-800" github="components/forms.md" show_dark=true >}}
...
<label for="disabled-toggle" class="inline-flex relative items-center mb-3 cursor-pointer">
