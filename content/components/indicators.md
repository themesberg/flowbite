...
<span class="flex w-3 h-3 me-3 bg-quaternary rounded-full"></span>
...
<ol class="flex items-center">
    ...
    <li class="relative w-full mb-6">
        <div class="flex items-center">
            <div class="z-10 flex items-center justify-center w-6 h-6 bg-tertiary rounded-full ring-0 ring-buffer sm:ring-8 shrink-0">
...
<div class="flex items-center justify-center bg-secondary-soft h-56 w-56 border border-default text-fg-brand-strong text-xs font-medium rounded-base">
...
<div class="relative bg-secondary-soft h-56 w-56 border border-default text-fg-brand-strong text-xs font-medium rounded-base">
