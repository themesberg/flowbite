...
{{< example id="loading-indicator-example" class="space-y-8" github="components/indicators.md" show_dark=true >}}
...
{{< example id="spinner-indicator-example" class="space-y-8" github="components/indicators.md" show_dark=true >}}
<div class="flex items-center justify-center w-56 h-56 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-800 dark:border-gray-700">
    <div role="status">
