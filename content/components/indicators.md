...
<div class="flex items-center justify-center bg-secondary-soft h-56 w-56 border border-base text-fg-brand-strong text-xs font-medium rounded-base">
...
<div class="relative bg-secondary-soft h-56 w-56 border border-base text-fg-brand-strong text-xs font-medium rounded-base">
