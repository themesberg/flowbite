...
{{< example id="default-jumbotron-example" github="components/jumbotron.md" show_dark=true >}}
...
{{< example id="background-jumbotron-example" github="components/jumbotron.md" show_dark=true >}}
<section class="bg-center bg-no-repeat bg-[url('https://flowbite.s3.amazonaws.com/docs/jumbotron/conference.jpg')] bg-gray-700 bg-blend-multiply">
    <div class="px-4 mx-auto max-w-screen-xl text-center py-24 lg:py-56 lg:px-12">
...
{{< example id="video-jumbotron-example" github="components/jumbotron.md" show_dark=true >}}
<section class="bg-white dark:bg-gray-900">
    <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-12 grid lg:grid-cols-2 gap-8 lg:gap-16">
...
{{< example id="form-jumbotron-example" bodyClass="bg-gray-50 dark:bg-gray-900" github="components/jumbotron.md" show_dark=true >}}
...
{{< example id="gradient-jumbotron-example" github="components/jumbotron.md" show_dark=true >}}

{{< /example >}}

## Jumbotron with cards

{{< example id="cards-jumbotron-example" github="components/jumbotron.md" show_dark=true >}}
