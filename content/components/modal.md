...
<table class="min-w-full my-10 text-sm text-left text-gray-500 shadow-md dark:border-gray-700 dark:text-gray-400">
    ...
    <tbody>
        <tr class="border-b dark:bg-gray-800 dark:border-gray-700">
            ...
            <td class="px-6 py-4">
                Set the default state of the modal. If you set it to <code class="text-purple-600 dark:text-purple-400">true</code>, it will automatically show the modal after the object is created.
            </td>
        </tr>
        <tr class="border-b dark:bg-gray-800 dark:border-gray-700">
            <td class="px-6 py-4 font-medium">
