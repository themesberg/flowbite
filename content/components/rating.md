...
<article>
    ...
    <aside>
        ...
        <div class="flex items-center mt-3">
            ...
            <a href="#" class="ps-4 text-sm font-medium text-blue-600 hover:underline dark:text-blue-500 border-gray-200 md:mr-4 ml-4 rtl:mr-3 border-l rtl:border-l-0 rtl:border-r md:mb-0 dark:border-gray-600">Report abuse</a>
        </div>
    </aside>
</article>
{{< /example >}}
