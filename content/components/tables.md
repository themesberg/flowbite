    ...
    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
        ...
        <tbody>
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                ...
                <th scope="row" class="flex items-center px-6 py-4 text-gray-900 dark:text-white whitespace-nowrap">
...
{{< example github="components/tables.md" class="overflow-hidden" show_dark=true >}}
<div id="detailed-pricing" class="w-full mt-8 overflow-x-auto">
