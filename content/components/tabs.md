...
<ul class="hidden text-sm font-medium text-center text-gray-500 divide-x divide-gray-200 rounded-lg shadow sm:flex dark:divide-gray-700 dark:text-gray-400">
    <li class="w-full">
        <a href="#" class="inline-block w-full p-3 text-gray-900 bg-gray-100 rounded-l-lg border-4 border-transparent focus:border-4 focus:outline-none focus:border-blue-300 active dark:bg-gray-700 dark:text-white" aria-current="page">Profile</a>
    </li>
    <li class="w-full">
        <a href="#" class="inline-block w-full p-3 bg-white hover:text-gray-700 hover:bg-gray-50 border-4 border-transparent focus:border-4 focus:outline-none focus:border-blue-300 dark:hover:text-white dark:bg-gray-800 dark:hover:bg-gray-700">Dashboard</a>
    </li>
    <li class="w-full">
        <a href="#" class="inline-block w-full p-3 bg-white hover:text-gray-700 hover:bg-gray-50 border-4 border-transparent focus:border-4 focus:outline-none focus:border-blue-300 dark:hover:text-white dark:bg-gray-800 dark:hover:bg-gray-700">Settings</a>
    </li>
    <li class="w-full">
        <a href="#" class="inline-block w-full p-3 bg-white rounded-r-lg hover:text-gray-700 hover:bg-gray-50 border-4 border-transparent focus:border-4 focus:outline-none focus:border-blue-300 dark:hover:text-white dark:bg-gray-800 dark:hover:bg-gray-700">Invoice</a>
    </li>
</ul>
{{< /example >}}
