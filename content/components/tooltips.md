...
{{< example id="default-tooltip-example" class="dark:bg-gray-800" github="components/tooltips.md" show_dark=true >}}
...
{{< example id="tooltip-styles-example" class="dark:bg-gray-800" github="components/tooltips.md" show_dark=true >}}
<!-- Light style tooltip -->
...
{{< example id="tooltip-placement-example" class="dark:bg-gray-800" github="components/tooltips.md" show_dark=true >}}
<!-- Show tooltip on top -->
...
{{< example id="tooltip-triggering-example" class="dark:bg-gray-800" github="components/tooltips.md" show_dark=true >}}
...
{{< example id="tooltip-animation-example" class="dark:bg-gray-800" github="components/tooltips.md" show_dark=true >}}
...
{{< example id="tooltip-disable-arrow-example" class="dark:bg-gray-800" github="components/tooltips.md" show_dark=true >}}
