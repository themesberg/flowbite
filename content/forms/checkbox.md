...
<!-- Dropdown menu -->
<div id="dropdownSearch" class="z-10 bg-primary-medium border border-base-medium rounded-base shadow-lg w-60 block">
    <div class="px-2 pt-2">
...
<ul class="grid w-full gap-4 md:grid-cols-3">
    <li>
        ...
        <label for="react-option" class="inline-flex items-center justify-between w-full p-5 text-body bg-primary-soft border-1 border-base rounded-base cursor-pointer peer-checked:hover:bg-brand-softer peer-checked:border-brand-subtle peer-checked:bg-brand-softer hover:bg-secondary-medium peer-checked:text-fg-brand-strong">                           
            <div class="block">
