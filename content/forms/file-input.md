...
{{< example id="default-file-upload-example" class="dark:bg-gray-800" github="forms/file-input.md" show_dark=true >}}
...
{{< example id="file-upload-helper-example" class="dark:bg-gray-800" github="forms/file-input.md" show_dark=true >}}
<label class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300" for="file_input">Upload file</label>
...
{{< example id="file-upload-multiple-example" class="dark:bg-gray-800" github="forms/file-input.md" show_dark=true >}}
...
{{< example id="file-upload-sizes-example" class="dark:bg-gray-800" github="forms/file-input.md" show_dark=true >}}
...
{{< example id="file-upload-dropzone-example" class="dark:bg-gray-800" github="forms/file-input.md" show_dark=true >}}
