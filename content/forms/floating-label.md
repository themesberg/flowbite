...
{{< example id="default-floating-label-example" class="grid gap-6 items-end w-full md:grid-cols-3 dark:bg-gray-800" github="forms/floating-label.md" show_dark=true >}}
<div class="relative">
...
{{< example id="floating-label-disabled-example" class="grid gap-6 items-end lg:grid-cols-3 dark:bg-gray-800" github="forms/floating-label.md" show_dark=true >}}
<div class="relative">
...
<!-- Success messages -->
<div class="grid gap-6 items-end mb-6 lg:grid-cols-3">
    <div>
        <div class="relative">
...
<!-- Error messages -->
<div class="grid gap-6 items-end lg:grid-cols-3">
    <div>
        <div class="relative">
