...
<form class="max-w-sm mx-auto">
    <div class="flex items-center -space-x-px shadow-xs rounded-base">
        ...
        <div class="relative w-full">
            <input type="phone" id="phone-input" class="w-full z-20 bg-secondary-medium border border-base-medium text-heading text-sm rounded-e-base focus:ring-brand focus:border-brand block w-full px-3 py-2.5 placeholder:text-body" pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}" placeholder="123-456-7890" required />
        </div>
    </div>
</form>
{{< /example >}}
