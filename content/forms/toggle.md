...
<label for="disabled-checked-toggle" class="flex relative items-center cursor-pointer">
...
<label for="red-toggle" class="flex relative items-center mr-5 cursor-pointer">
...
<label for="green-toggle" class="flex relative items-center mr-5 cursor-pointer">
...
<label for="purple-toggle" class="flex relative items-center mr-5 cursor-pointer">
...
<label for="yellow-toggle" class="flex relative items-center mr-5 cursor-pointer">
...
<label for="teal-toggle" class="flex relative items-center mr-5 cursor-pointer">
...
<label for="orange-toggle" class="flex relative items-center mr-5 cursor-pointer">
...
{{< example class="dark:bg-gray-800" github="components/forms.md" show_dark=true >}}
<label for="small-toggle" class="flex relative items-center mb-5 cursor-pointer">
...
<label for="default-toggle-size" class="flex relative items-center mb-5 cursor-pointer">
...
<label for="large-toggle" class="flex relative items-center cursor-pointer">
