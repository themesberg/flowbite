...
if (document.getElementById("wysiwyg-example")) {
    const editor = new Editor({
        ...
        content: '<p>Hello World!</p><p>Hello World!</p><p>Hello World!</p><p>Hello World!</p><p>Hello World!</p>',
        editorProps: {
            attributes: {
                class: 'format lg:format-lg dark:format-invert focus:outline-none',
            },
        }
    })
}
