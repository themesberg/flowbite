...
<a href="#" class="inline-flex items-center justify-center p-5 text-base font-medium border border-default hover:border-default-medium text-body rounded-base bg-secondary-soft hover:text-heading hover:bg-tertiary">
