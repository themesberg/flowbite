...
{{< example id="default-checkbox-example" class="flex items-center space-x-4" github="forms/checkbox.md" show_dark=true >}}
<p class="text-xs text-gray-900 dark:text-white">Aa</p>
<p class="text-sm text-gray-900 dark:text-white">Aa</p>
<p class="text-gray-900 dark:text-white">Aa</p>
...
{{< example id="default-checkbox-example" class="space-y-3" github="forms/checkbox.md" show_dark=true >}}
...
{{< example id="default-checkbox-example" github="forms/checkbox.md" show_dark=true >}}
<span class="text-3xl font-bold text-gray-900 line-through dark:text-white">$109</span><span class="ml-3 text-3xl font-bold">$79</span>
{{< /example >}}
...
{{< example id="default-checkbox-example" github="forms/checkbox.md" show_dark=true >}}
<p class="mb-4 text-3xl font-extrabold text-gray-900 md:text-4xl dark:text-white">The crypto <span class="uppercase">identity</span> primitive.</p>
{{< /example >}}
...
{{< example id="default-checkbox-example" github="forms/checkbox.md" show_dark=true >}}
<p class="mb-4 text-3xl font-semibold text-gray-900 md:text-4xl dark:text-white">The crypto <span class="italic">identity</span> primitive.</p>
{{< /example >}}

### Normal

{{< example id="default-checkbox-example" github="forms/checkbox.md" show_dark=true >}}
<p class="mb-4 text-3xl font-semibold text-gray-900 md:text-4xl dark:text-white">The crypto identity primitive.</p>
{{< /example >}}
...
{{< example id="default-checkbox-example" github="forms/checkbox.md" show_dark=true >}}
<p class="text-gray-500 md:text-lg dark:text-gray-400">Get started with an enterprise-level, profesionally designed, fully responsive, and HTML semantic set of web pages, sections and over 400+ components crafted with the utility classes from Tailwind CSS and based on the Flowbite component library</p>
{{< /example >}}
...
{{< example id="default-checkbox-example" github="forms/checkbox.md" show_dark=true >}}
<p class="text-center text-gray-500 md:text-lg dark:text-gray-400">Get started with an enterprise-level, profesionally designed, fully responsive, and HTML semantic set of web pages, sections and over 400+ components crafted with the utility classes from Tailwind CSS and based on the Flowbite component library</p>
{{< /example >}}
...
{{< example id="default-checkbox-example" github="forms/checkbox.md" show_dark=true >}}
<p class="text-right text-gray-500 md:text-lg dark:text-gray-400">Get started with an enterprise-level, profesionally designed, fully responsive, and HTML semantic set of web pages, sections and over 400+ components crafted with the utility classes from Tailwind CSS and based on the Flowbite component library</p>
{{< /example >}}
...
{{< example id="default-checkbox-example" github="forms/checkbox.md" show_dark=true >}}
<p class="text-justify text-gray-500 md:text-lg dark:text-gray-400">Get started with an enterprise-level, profesionally designed, fully responsive, and HTML semantic set of web pages, sections and over 400+ components crafted with the utility classes from Tailwind CSS and based on the Flowbite component library</p>
{{< /example >}}
...
{{< example id="default-checkbox-example" github="forms/checkbox.md" show_dark=true >}}
<div class="text-gray-500 whitespace-normal dark:text-gray-400">
...
{{< example id="default-checkbox-example" github="forms/checkbox.md" show_dark=true >}}
<div class="text-gray-500 whitespace-nowrap dark:text-gray-400">
This is some text. This is some text. This is some text.
This is some text. This is some text. This is some text.
This is some text. This is some text. This is some text.
This is some text. This is some text. This is some text.
...
{{< example id="default-checkbox-example" github="forms/checkbox.md" show_dark=true >}}
<div class="text-gray-500 whitespace-pre-line dark:text-gray-400">
This is some text. This is some text. This is some text.
This is some text. This is some text. This is some text.
This is some text. This is some text. This is some text.
This is some text. This is some text. This is some text.
