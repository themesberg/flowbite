...
function initCollapse() {
  var parent = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : document;
  parent.querySelectorAll('[data-collapse-toggle]').forEach(function (triggerEl) {
...
function initModal() {
  var parent = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : document;
  var modalInstances = [];
  parent.querySelectorAll('[data-modal-toggle]').forEach(function (el) {
...
window.flowbite = window.flowbite || {};
window.flowbite.initTooltip = initTooltip;
